...
INSERT INTO `auth` (`id`, `groupid`, `code`, `area`, `rights`, `rights_lock`) VALUES
	...
	(19, '3', 'admin', 'a', '0', '31'),
	(20, '4', 'admin', 'a', '31', '0'),
	(21, '0', 'forums', 'public', '1', '30'),
	(22, '0', 'forums', 'general', '1', '30'),
	(23, '0', 'forums', 'offtopic', '1', '30'),
	(24, '1', 'forums', 'public', '0', '31'),
	(25, '1', 'forums', 'general', '0', '31'),
	(26, '1', 'forums', 'offtopic', '0', '31'),
	(27, '2', 'forums', 'public', '0', '31'),
	(28, '2', 'forums', 'general', '0', '31'),
	(29, '2', 'forums', 'offtopic', '0', '31'),
	(30, '3', 'forums', 'public', '11', '20'),
	(31, '3', 'forums', 'general', '11', '20'),
	(32, '3', 'forums', 'offtopic', '11', '20'),
	(33, '4', 'forums', 'public', '31', '0'),
	(34, '4', 'forums', 'general', '31', '0'),
	(35, '4', 'forums', 'offtopic', '31', '0');
...
CREATE TABLE IF NOT EXISTS `forums_posts` (
	...
	`cat` varchar(255) collate utf8_unicode_ci NOT NULL default '',
	...
	PRIMARY KEY  (`id`),
	UNIQUE KEY `topicid` (`topicid`,`id`),
	KEY `updated` (`creation`),
...
INSERT INTO `forums_sections` (`id`, `code`, `path`, `title`, `desc`) VALUES
	(1, 'public', '1', 'Public', 'Open to everyone'),
	(2, 'general', '1.1', 'General discussion', 'Open discussion about anything'),
	(3, 'offtopic', '1.2', 'Off-Topic', 'Otherwise odd conversation');
...
CREATE TABLE IF NOT EXISTS `forums_topics` (
	...
	`postcount` mediumint(8) NOT NULL default '0',
	`viewcount` mediumint(8) NOT NULL default '0',
	`lastposter` int(11) NOT NULL default '-1',
	`firstposter` int(11) NOT NULL default '-1',
	PRIMARY KEY  (`id`),
	KEY `sticky` (`sticky`),
	KEY `cat` (`cat`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
